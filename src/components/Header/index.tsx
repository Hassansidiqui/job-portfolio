            ...
            <div className="w-60 max-w-full px-4 xl:mr-12">
              ...
              >
                <div className="flex items-center space-x-2">
                  {/* Circle icon with initials */}
                  <div className="flex h-10 w-10 items-center justify-center rounded-full bg-gradient-to-br from-green-400 to-blue-500 text-white font-bold text-lg">
                    MHS
                  </div>
                  {/* Portfolio Text */}
